  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="icon" className="w-8 h-8 rounded-full border-border/50 bg-surface shadow-sm hover:bg-surface-2 hover:text-foreground transition-all" title="Processing History">
